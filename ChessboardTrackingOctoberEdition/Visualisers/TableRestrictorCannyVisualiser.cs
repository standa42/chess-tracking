...
{
    class TableRestrictorCannyVisualiser : IVisualiser
    {
        ...
        public TableRestrictorCannyVisualiser(Form form, IKinect kinect, StateAutomataWrapper stateAutomata)
        {
            this.kinect = kinect;
            ...
            DepthSpacePoint[] pointsFromColorToDepth, ColorSpacePoint[] pointsFromDepthToColor)
        {
            ...
            Image<Gray, Byte> cannyEdges = grayImage.Canny(75, 100, 3, true); //(45, 160, 3, true);
