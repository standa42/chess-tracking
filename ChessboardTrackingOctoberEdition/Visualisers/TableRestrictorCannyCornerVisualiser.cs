...
{
    class TableRestrictorCannyCornerVisualiser : IVisualiser
    {
        ...
        public TableRestrictorCannyCornerVisualiser(Form form, IKinect kinect, StateAutomataWrapper stateAutomata)
        {
            this.kinect = kinect;
