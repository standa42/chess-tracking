...
namespace Kinect_v0._1
{
    ...
    public class Data
    {
        ...
        public void RotationTo2D(Form1 form)
        {
            ...
            form.SetNormal(Config.finalNormal.x, Config.finalNormal.y, Config.finalNormal.z, tableCenter.x, tableCenter.y, tableCenter.z);
        }
        ...
        public void LocateObjects(Form1 form)
        {
